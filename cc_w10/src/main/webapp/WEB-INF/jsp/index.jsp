			...
			<div class="container text-center">
				...
				<form class="form-horizontal" method="POST" action="save-content">
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<input type="text" class="form-control" name="title" value="${content.tittle}"/>
						</div>				
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Content</label>
						<div class="col-md-7">
							<textarea class="form-control" id="content" name="content" cols="70" rows="10">${content.content}</textarea>
						</div>				
					</div>
					<div class="form-group">
